/**
 * cuda_phase1.cu — Phase 1: Hash state preparation
 *
 * For each nonce:
...
// ============================================================
// AES S-box (constant memory, used for key expansion)
// ============================================================
...
// Explicit template instantiation (for cryptonight_gpu)
template __global__ void cryptonight_extra_gpu_prepare<cryptonight_gpu>(
	int threads,
