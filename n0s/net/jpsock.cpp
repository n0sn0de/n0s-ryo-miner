	...
	quiet_close(false)
{
	...
	prv = std::make_unique<opaque_private>(bJsonCallMem.get(), bJsonRecvMem.get(), bJsonParseMem.get());
...
jpsock::~jpsock()
{
	// prv, sck, bJsonCallMem, bJsonRecvMem, bJsonParseMem all freed automatically by unique_ptr
}
